...
Gem::Specification.new do |s|
  ...
  s.authors = [%q{kenneth.kalmer@gmail.com}]
  s.date = %q{2011-09-16}
...
To get started quickly run 'daemon-kit' without any arguments
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<safely>, [">= 0"])
      s.add_development_dependency(%q<jeweler>, ["~> 1.6.0"])
      s.add_development_dependency(%q<SyslogLogger>, [">= 0"])
    else
      s.add_dependency(%q<eventmachine>, [">= 0.12.10"])
      s.add_dependency(%q<safely>, [">= 0"])
